...
React.memo(({ cardNumber, onChange, onBlur, error }) => {
...
React.memo(({ expirationDate, onChange, onBlur, error }) => {
...
React.memo(({ cvcNumber, onChange, onBlur, error }) => {
...
React.memo(({ cardCompany, onChange }) => {
...
`;
const INPUT_COUNT = 1;
React.memo(({ cardPassword, onChange, onBlur, error }) => {
