...
var CardBackgroundColor = /* @__PURE__ */ ((CardBackgroundColor2) => {
  CardBackgroundColor2["BC카드"] = "#F04651";
  CardBackgroundColor2["신한카드"] = "#0046FF";
  CardBackgroundColor2["카카오뱅크"] = "#FFE600";
  CardBackgroundColor2["현대카드"] = "#000";
  CardBackgroundColor2["우리카드"] = "#007BC8";
  CardBackgroundColor2["롯데카드"] = "#ED1C24";
  CardBackgroundColor2["하나카드"] = "#009490";
  CardBackgroundColor2["국민카드"] = "#6A6056";
  return CardBackgroundColor2;
})(CardBackgroundColor || {});
const Card = ({ cardNumbers, cardCompany, expirationDate }) => {
  const backgroundColor = CardBackgroundColor[cardCompany] ?? "#000";
  const getBadgeImagePath = (firstNumber) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container$2, { $cardBackgroundColor: backgroundColor, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Wrap, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Chip, {}),
      getBadgeImagePath(cardNumbers.first) && /* @__PURE__ */ jsxRuntimeExports.jsx(BrandBadge, { src: getBadgeImagePath(cardNumbers.first), alt: "brand badge" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardInfoWrap, { children: Object.entries(cardNumbers).map(([key, value]) => {
      ...
      const displayValue = isBlind ? "•".repeat(value == null ? void 0 : value.length) : value;
      return /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "card-number-blind", children: displayValue }, key);
    }) }),
...
const Input = ({ isError = false, onChange, onBlur, ref, ...rest }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(TextInput, { ref, onChange: onChange && ((e) => onChange(e)), onBlur: onBlur && ((e) => onBlur(e)), $isError: isError, ...rest });
};
...
const getCurrentYear = () => (/* @__PURE__ */ new Date()).getFullYear() % 100;
...
const isValidateExpirationDate = (expirationDate) => {
...
const isValidateCvc = (cvcNumber) => {
  return cvcNumber.length === CVC_MAX_LENGTH && isNumberWithinRange(cvcNumber, 3);
};
const useAutoFocus = (inputCount, maxLength) => {
  const inputRef = Array.from({ length: inputCount }, () => {
    return reactExports.useRef(null);
  });
  const moveFocus = (index, numbers) => {
    var _a, _b;
    if (numbers.length === maxLength && index !== inputCount - 1) {
      (_b = (_a = inputRef[index + 1]) == null ? void 0 : _a.current) == null ? void 0 : _b.focus();
    }
  };
  reactExports.useEffect(() => {
    var _a, _b;
    (_b = (_a = inputRef[0]) == null ? void 0 : _a.current) == null ? void 0 : _b.focus();
  }, []);
  return { inputRef, moveFocus };
};
const INPUT_COUNT$3 = 4;
const CardNumber = React.memo(({ cardNumber, onChange, onBlur, error }) => {
  const orderLabels = ["first", "second", "third", "fourth"];
  const { inputRef, moveFocus } = useAutoFocus(INPUT_COUNT$3, CARD_MAX_LENGTH);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(CardNumberWrap$4, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(InputField, { label: "카드 번호", errorMessage: findErrorOrder(error), children: orderLabels.map((label, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Input,
      {
        ref: inputRef[index],
        isError: !!error[label],
...
const CardNumberWrap$4 = dt.div`
	height: 130px;
`;
const INPUT_COUNT$2 = 2;
const ExpirationDate = React.memo(({ expirationDate, onChange, onBlur, error }) => {
  const orderLabels = ["month", "year"];
  const { inputRef, moveFocus } = useAutoFocus(INPUT_COUNT$2, EXPIRATION_MAX_LENGTH);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(CardNumberWrap$3, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(InputField, { label: "유효기간", errorMessage: findErrorOrder(error), children: orderLabels.map((label, index) => {
...
const CardNumberWrap$3 = dt.div`
	height: 130px;
`;
const INPUT_COUNT$1 = 1;
const CardCvc = React.memo(({ cvcNumber, onChange, onBlur, error }) => {
  const { inputRef } = useAutoFocus(INPUT_COUNT$1, CVC_MAX_LENGTH);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(CardNumberWrap$2, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(InputField, { label: "CVC", errorMessage: error, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { ref: inputRef[0], maxLength: CVC_MAX_LENGTH, isError: !!error, placeholder: "123", value: cvcNumber, onChange: (e) => onChange(e.target.value), onBlur: (e) => onBlur(e.target.value) }) })
  ] });
});
const CardNumberWrap$2 = dt.div`
	height: 120px;
`;
const Select = ({ options, cardCompany, onChange }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContainer, { $cardCompany: cardCompany, onChange: onChange && ((e) => onChange(e.target.value)), children: [
...
const SelectContainer = dt.select`
	width: 100%;
	padding: 8px;
...
`;
const Option = dt.option`
	outline: none;
	border: none;
`;
const CARD_COMPANIES = ["BC카드", "신한카드", "카카오뱅크", "현대카드", "우리카드", "롯데카드", "하나카드", "국민카드"];
const CardCompany = React.memo(({ cardCompany, onChange }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(CardNumberWrap$1, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Description, { children: "현재 국내 카드사만 가능합니다." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Select, { options: CARD_COMPANIES, cardCompany, onChange })
  ] });
});
...
`;
const INPUT_COUNT = 1;
const CardPassword = React.memo(({ cardPassword, onChange, onBlur, error }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(CardNumberWrap, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Description, { children: "앞의 2자리를 입력해주세요" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(InputField, { label: "비밀번호 앞 2자리", errorMessage: error, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Input,
      {
        ref: inputRef[0],
        type: "password",
...
const Button = ({ type, children, onClick, ...rest }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ButtonStyled, { type, onClick, ...rest, children });
};
...
const useCardNumber = () => {
  ...
  const [error, setError] = reactExports.useState({ first: "", second: "", third: "", fourth: "" });
  const isComplete = isValidCardNumber(cardNumber);
  const onChange = (order, value) => {
...
const useExpirationDate = () => {
  ...
  const [error, setError] = reactExports.useState({ month: "", year: "" });
  const isComplete = isValidateExpirationDate(expirationDate);
  const CURRENT_YEAR = (/* @__PURE__ */ new Date()).getFullYear() % 100;
  const updateExpirationDate = (order, value) => {
    setExpirationDate((prev2) => ({ ...prev2, [order]: value }));
  };
  const validateInputFormat = (order, value) => {
  ...
  const validateMonthRange = (value) => {
    if (!isValidMonth(value)) {
      setError((prev2) => ({ ...prev2, month: MESSAGE.MONTH_RANGE }));
      return false;
    }
    return true;
  };
  const validateYearRange = (value) => {
    if (!isValidYear(value)) {
      setError((prev2) => ({ ...prev2, year: MESSAGE.YEAR_RANGE(CURRENT_YEAR) }));
      return false;
    }
    return true;
  };
  const clearError = (order) => {
...
const useFormStepControl = (isComplete) => {
  const [maxStep, setMaxStep] = reactExports.useState(0);
  const step = Object.values(isComplete).filter(Boolean).length;
  reactExports.useEffect(() => {
    setMaxStep((prev2) => Math.max(prev2, step));
  }, [step]);
  return { step, maxStep };
};
...
function App$1() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(MainContainer, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { cardNumbers: cardNumberHook.cardNumber, cardCompany: cardCompanyHook.cardCompany, expirationDate: expirationDateHook.expirationDate }),
    maxStep >= RENDERING_STEP.password && /* @__PURE__ */ jsxRuntimeExports.jsx(CardPassword, { ...cardPasswordHook }),
    maxStep >= RENDERING_STEP.cvc && /* @__PURE__ */ jsxRuntimeExports.jsx(CardCvc, { ...cardCvcHook }),
    maxStep >= RENDERING_STEP.expirationDate && /* @__PURE__ */ jsxRuntimeExports.jsx(ExpirationDate, { ...expirationDateHook }),
    maxStep >= RENDERING_STEP.company && /* @__PURE__ */ jsxRuntimeExports.jsx(CardCompany, { ...cardCompanyHook }),
    maxStep >= RENDERING_STEP.cardNumber && /* @__PURE__ */ jsxRuntimeExports.jsx(CardNumber, { ...cardNumberHook }),
    step === 5 && /* @__PURE__ */ jsxRuntimeExports.jsx(ButtonWrap, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "button", onClick: () => navigate("/addSuccess", { state: { firstCardNumber: cardNumberHook.cardNumber.first, cardCompany: cardCompanyHook.cardCompany } }), children: "확인" }) })
  ] }) });
}
...
const CardAddSuccess = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "./images/Success.svg", alt: "success Adding Card" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(AddText, { children: [
      firstCardNumber,
      "로 시작하는",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "button", onClick: () => navigate("/"), children: "확인" })
  ] });
};
